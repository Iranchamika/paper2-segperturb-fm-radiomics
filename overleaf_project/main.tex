...
% Line numbers DISABLED for the reading/draft build.
% To re-enable for the Medical Physics submission version (the journal requires
% numbered lines on the submission PDF for reviewer convenience), uncomment the
% two commands below. \modulolinenumbers[5] prints numbers only every fifth line
% (5, 10, 15, ...) which is the conventional submission-review compromise; remove
% it as well if every-line numbering is preferred.
% \linenumbers
% \modulolinenumbers[5]
